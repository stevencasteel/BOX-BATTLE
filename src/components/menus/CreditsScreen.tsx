...
export function CreditsScreen({ onBack }: CreditsScreenProps) {
  return (
    <div className="flex-col h-full w-full" style={{ justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div className="credits-block neo-pressed flex-col" style={{ width: "100%", maxWidth: "68vmin", padding: "3.2vmin", borderRadius: "2vmin", boxSizing: "border-box" }}>
        <div style={{ textAlign: "center", borderBottom: "1px solid rgba(255,255,255,0.03)", paddingBottom: "1.2vmin", marginBottom: "1.2vmin" }}>
          <p style={{ fontSize: "1.6vmin", fontWeight: "bold", color: "#22c55e", textTransform: "uppercase", letterSpacing: "0.15em", margin: 0, textShadow: "0 0 8px rgba(34, 197, 94, 0.45)" }}>Built by Steven Casteel</p>
          <p style={{ fontSize: "1.2vmin", color: "#4ade80", margin: "0.6vmin 0 0", letterSpacing: "0.12em", textTransform: "uppercase", fontWeight: "bold", textShadow: "0 0 6px rgba(74, 222, 128, 0.2)" }}>AI Co-Pilots: Gemini 2.5 Pro, Gemini 3.5 Flash</p>
          <a 
            href="https://www.stevencasteel.com" 
            target="_blank" 
            rel="noopener noreferrer" 
            style={{ display: "inline-block", fontSize: "1.1vmin", color: "#4a5568", margin: "0.6vmin 0 0", letterSpacing: "0.15em", textDecoration: "none", transition: "color 0.15s ease" }}
